    ...
    return (
        ...
        <>
            <div className="botonVerificar">
                <button type="submit" id="btnverificar" className='mb-4 w-100 gradient-custom-2' class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                    {modificarbtnModal}
                </button>
            </div>
            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <Link to={modificarRuta}><button type="button" id="btncontinuar" class="btn btn-primary" data-bs-dismiss="modal">Continuar</button></Link>
